...
public class LinkCtrlEvents {
	 ...
	 */
	public void openAD1() {
		urt.submitThread(urt.new SendCommandThread(
				mainFrame.getFpga1Ip(), FinalVar.PORT_1,
	...
	public void closeAD1() {
		urt.submitThread(urt.new SendCommandThread(mainFrame.getFpga1Ip(), 
				FinalVar.PORT_1,
	 ...
	 */
	public void openDA1() {
		udpSocket.sendUdpMesg(mainFrame.getFpga1Ip(), FinalVar.PORT_1,
